...
const ItemDetailContainer = () => {
        ...
        if(test == null){
            ...
            item.innerHTML+=  `<div class="${product.id} product__incart"> ${product.title} <div class="${product.id}__quantity spacer">${product__quantity}</div> <div class="${product.id}__price product__incart--price">${product.price} </div> $ </div>`;
